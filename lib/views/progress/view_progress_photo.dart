...
import 'package:heronfit/views/progress/compare_progress_photo.dart';
                              ...
                              child: Stack(
                                children: [
                                  Container(
                                    ...
                                    child: _progressData.isNotEmpty
                                        ? ClipRRect(
                                            borderRadius: BorderRadius.circular(8),
                                            child: Image.network(
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => const CompareProgressPhotosWidget(),
                                            ),
                                          );
                                        },
                                      ),
                                  ...
                                  Align(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _progressData.isNotEmpty
                                              ? _formatDate(_progressData[_selectedPhotoIndex]['date'])
                                              : 'No date data',
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: Theme.of(context).colorScheme.secondaryContainer,
                                                  borderRadius: BorderRadius.circular(8),
                                                  border: _selectedPhotoIndex == index
                                                      ? Border.all(
                                                          color: Theme.of(context).primaryColor,
                                                          width: 3,
                                                        )
