...
class HybridRecommendationService extends BaseRecommendationService {
  final ContentBasedRecommendationService _contentBasedService =
      ContentBasedRecommendationService();
  final CollaborativeRecommendationService _collaborativeService =
      CollaborativeRecommendationService();
  final RandomRecommendationService _randomService =
